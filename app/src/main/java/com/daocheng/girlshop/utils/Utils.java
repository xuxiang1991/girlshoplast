...
//            context.startActivity(intent);
    ...
    public static DisplayImageOptions defaultOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.loading_error)//设置图片在下载期间显示的图片
                .showImageForEmptyUri(R.drawable.loading_error)//设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.drawable.loading_error)//设置图片加载/解码过程中错误时候显示的图片
                .delayBeforeLoading(200)//设置延时多少时间后开始下载
                ...
                .displayer(new BitmapDisplayer() {
                    ...
                    public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom) {
                        imageAware.setImageDrawable(new RoundedBitmapDisplayer.RoundedDrawable(bitmap, 20, 0));
                        FadeInBitmapDisplayer.animate(imageAware.getWrappedView(), 800);
                    }
                })//自定义设置圆角和渐入动画
...
//                .displayer(new FadeInBitmapDisplayer(800))//是否图片加载好后渐入的动画时间
    ...
    public static DisplayImageOptions EditPhotoOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.loading_error)//设置图片在下载期间显示的图片
                .showImageForEmptyUri(R.drawable.loading_error)//设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.drawable.loading_error)//设置图片加载/解码过程中错误时候显示的图片
