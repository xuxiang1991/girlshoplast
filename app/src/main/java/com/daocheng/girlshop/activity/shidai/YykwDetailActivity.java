...
/**
 * Created by XX on 2016/8/29.
 */
public class YykwDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private static int TYPE_FUXI = 16;
    ...
    protected int getLayoutId() {
        return R.layout.activity_yykw_detail;
    }
    ...
    private void setData() {
        ShidaiApi.getDatayykw(self, id, TYPE_FUXI, Config.getShidaiUserInfo().getUserid(), pageNo, Constant.pageNum, fuxiList.class, new NetUtils.NetCallBack<ServiceResult>() {
            @Override
...
//                .showImageOnLoading(R.drawable.loading_photo)
    ...
    private String baseurl = "http://www.cs66club.com/app/share_preview?";
