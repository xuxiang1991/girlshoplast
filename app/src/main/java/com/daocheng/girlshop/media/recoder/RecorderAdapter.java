...
public class RecorderAdapter extends ArrayAdapter<recoderActivity.Recorder> {
	...
	public RecorderAdapter(Context context, List<recoderActivity.Recorder> dataList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.item_record_layout, parent, false);
