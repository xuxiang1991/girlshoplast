...
public class AppConfigActivity extends Activity {
    ...
    public void onOkBtnClick(){
        ...
        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(myApplication.self).edit();
    ...
    private void loadAppConfig(){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(myApplication.self);
