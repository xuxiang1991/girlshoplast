...
public class MainActivity extends AppCompatActivity {
    ...
    private FspUserView ensureUserView(String userid, String videoid) {
        ...
        for (FspUserView userView : m_list_userviews) {
            if (com.hst.meetingdemo.utils.FspUtils.isSameText(userid, userView.getUserId())) {
                if (com.hst.meetingdemo.utils.FspUtils.isSameText(videoid, userView.getVideoId())) {
                    return userView;
                } else if (firstUserView == null &&
                        (com.hst.meetingdemo.utils.FspUtils.isEmptyText(videoid) || com.hst.meetingdemo.utils.FspUtils.isEmptyText(userView.getVideoId()))){
                    firstUserView = userView;
                }
            }

            if (firstFreeView == null && com.hst.meetingdemo.utils.FspUtils.isEmptyText(userView.getUserId())) {
